...
function Run(){
	// get the ccorners by creating functions which select an item from the data which has the correct values.
	...
	console.log("Bounding box computed for arc313@tamu.edu: ");
